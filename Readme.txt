...
Pytorch model using transfer learning from alexnet.

About:

The model has been used for distinguishing between Bee and Ants using pretrained alexnet model, the alternation done here
...
distinguishing between ants and bees, so i ahve performed the below command for alteration.
